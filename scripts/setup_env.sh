...
( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | android update sdk --all --filter android-23,tools,platform-tools,build-tools-23.0.1,extra-android-m2repository,extra-google-m2repository --no-ui --force
source ~/.bash_profile
