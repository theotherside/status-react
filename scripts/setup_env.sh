...
# unsure if build-tools-23.0.3 is necessary
( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | android update sdk --all --filter android-23,tools,platform-tools,build-tools-23.0.3,build-tools-23.0.1 --no-ui --force
source ~/.bash_profile
